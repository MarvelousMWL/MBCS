...
public interface ProductRepository {
    ...
    // ADBC new tables
    List<ProductCloseControl> findCloseControls(String code); void saveCloseControl(ProductCloseControl c); void deleteCloseControl(String code);
    List<ProductDepositControl> findDepositControls(String code); void saveDepositControl(ProductDepositControl c); void deleteDepositControl(String code);
    List<ProductInterestDefinition> findInterestDefinitions(String code); void saveInterestDefinition(ProductInterestDefinition c); void deleteInterestDefinition(String code);
    List<ProductRateDefinition> findRateDefinitions(String code); void saveRateDefinition(ProductRateDefinition c); void deleteRateDefinition(String code);
}
