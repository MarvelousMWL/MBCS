        ...
        <el-menu :default-active="activeMenu" :collapse="collapsed" router class="sidebar-menu">
          ...
          <el-sub-menu index="account-mod">
            ...
            <el-menu-item-group title="限制"><template #title><span style="font-size:11px;color:#a0aec0;padding:0 8px">- 限制 -</span></template>
              <el-menu-item index="/account/restriction"><span>限制总览</span></el-menu-item>
              <el-menu-item index="/account/freeze"><span>账户冻结</span></el-menu-item>
          ...
          <el-sub-menu index="trans-mod">
            ...
            <el-menu-item index="/transfer"><span>行内转账</span></el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="cd-mod">
            ...
            <el-menu-item index="/certificate-deposit/product"><span>产品期次</span></el-menu-item>
            <el-menu-item index="/certificate-deposit/subscribe"><span>认购</span></el-menu-item>
            <el-menu-item index="/certificate-deposit/redeem"><span>兑付</span></el-menu-item>
            <el-menu-item index="/certificate-deposit/transfer"><span>转让</span></el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="notice-mod">
            ...
            <el-menu-item index="/notice-deposit"><span>开户与支取</span></el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu index="batch-mod">
            ...
            <el-menu-item index="/batch/execute"><span>批量执行</span></el-menu-item>
          </el-sub-menu>
