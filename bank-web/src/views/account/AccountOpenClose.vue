...
var loadSubs=async()=>{if(!lForm.customerAccountNo||!lForm.accountType){subs.value=[];return}try{var r=await getCustomerSubAccountByType(lForm.customerAccountNo,lForm.accountType);subs.value=(r.data||[]).filter(i=>i.status===0)}catch(e){subs.value=[]}}
