  ...
  <div class="page">
    ...
    <el-card style="max-width:520px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="客户号" prop="customerNo"><el-input v-model="form.customerNo" placeholder="输入个人客户号"/></el-form-item>
        <el-form-item><el-alert type="info" :closable="false" show-icon title="个人账户类型将自动设置为 PERSONAL" style="margin:0"/></el-form-item>
