  ...
  <div class="page">
    ...
    <el-dialog v-model="newDlg" title="开通子账户" width="420px">
      <el-form ref="newFormRef" :model="newForm" :rules="newRules" label-width="100px">
        <el-form-item label="账户类型" prop="accountType"><el-select v-model="newForm.accountType" style="width:100%"><el-option label="活期 (DEMAND)" value="DEMAND"/><el-option label="定期 (TIME)" value="TIME"/></el-select></el-form-item>
      </el-form>
...
var queryDone=ref(false),subList=ref([]),newDlg=ref(false),newFormRef=ref(),newForm=reactive({accountType:'DEMAND'}),newRules={accountType:[{required:true,message:'请选择',trigger:'change'}]}
...
var showNewSub=()=>{newForm.accountType='DEMAND';newDlg.value=true}
